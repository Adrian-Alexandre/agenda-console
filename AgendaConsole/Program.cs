...
namespace AgendaConsole
{
    internal class Program
    {
        ...
        static void AlterarContato(ref String[] nome, ref String[] email, ref int tl)
        {
            try
            {
                ...
                if (pos != -1)
                {
                    ...
                    int posV = LocalizarContatos(email, tl, emailContato);
                    if (posV == -1 || posV == pos)
                    { 
                         nome[pos] = novoNome;
                         email[pos] = novoEmail;
        ...
        static Boolean ExcluirContatos(ref String[] nome, ref String[] email, ref int tl, String emailContato)
        {
            ...
            while (op != 6)
            {
                ...
                switch (op)
                {
                    ...
                    case 4:
                        ...
                        if (ExcluirContatos(ref nome, ref email, ref tl, emailContato))
                        {
